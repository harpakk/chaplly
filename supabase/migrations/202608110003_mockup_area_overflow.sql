...
declare raw_width numeric; raw_height numeric; mockup_side text; product_has_back boolean;
begin
  select raw_view.print_area_width,raw_view.print_area_height,mockup.side,product.has_back
    into raw_width,raw_height,mockup_side,product_has_back
  ...
  if new.area_height>1.8 or new.area_x>1 or new.area_y>1
...
begin
  ...
  if area_height>1.8 or p_area_x>1 or p_area_y>1 or p_area_x+p_area_width<0 or p_area_y+area_height<0 then raise exception 'MOCKUP_AREA_OUT_OF_BOUNDS'; end if;
