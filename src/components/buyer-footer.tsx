  ...
  return (
    <footer className="buyer-footer">
      ...
      <div className="shop-container footer-grid seo-footer">
        ...
        <div><strong>راهنمای چاپلی</strong><Link href="/blog">مجله چاپلی</Link><Link href="/support">روش‌های ارسال و پشتیبانی</Link><Link href="/terms#returns">۷ روز ضمانت بازگشت</Link><Link href="/terms#quality">تضمین کیفیت</Link><Link href="/support#faq">سؤالات متداول</Link><Link href="/support">تماس با پشتیبانی</Link></div>
